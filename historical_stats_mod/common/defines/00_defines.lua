...
NAI = {
	...
	LOCATION_BALANCE_TO_ADVANCE = 0.2,			-- Limit on location strength balance between country and enemy for unit to dare to move forward.
	...
	PLAN_FACTION_STRONG_TO_EXECUTE = 0.40,		-- % or more of units in an order to consider ececuting the plan
	...
	HOUR_BAD_COMBAT_REEVALUATE = 36,                   -- if we are in combat for this amount and it goes shitty then try skipping it 
