...
NMilitary = {
	...
	UNIT_EXPERIENCE_PER_COMBAT_HOUR = 0.0001,		-- was 0.0001, less rewarding than fight 18 hours
...
NNavy = {
	...
	EXPERIENCE_LOSS_FACTOR = 0.3,                 					-- percentage of experienced solders who die when manpower is removed. Was 0.1
