...
NProduction = {
	...
	BASE_FACTORY_SPEED_MIL = 4.6, 				-- Base factory speed multiplier (how much hoi3 style IC each factory gives).
...
NBuildings = {
	...
	RADAR_RANGE_MAX = 140,				-- Range is interpolated between building levels 1-15.
...
NMilitary = {
	...
	PLAN_CONSIDERED_GOOD = 0.55,					-- Plan evaluations above this value are considered more or less safe
...
NAI = {
	...
	TRADEABLE_FACTORIES_FRACTION = 1.1,			-- Will at most trade away this fraction of factories.
